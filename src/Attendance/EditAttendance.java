...
public class EditAttendance {
    ...
    public void editView() throws SQLException {
        ...
        view.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                tblupdt(String.valueOf(tmss.getSelectedItem()), dtbox.getText());
            }
        });
        ...
        del.setForeground(Color.decode("#124b70"));
        frame.add(del);
        del.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String adding = "DELETE FROM attend WHERE team = '"+String.valueOf(tmss.getSelectedItem())+"' AND dt = '"+dtbox.getText()+"'";
                try {
    ...
    public ResultSet dbSearch(String teams, String dt) throws SQLException {
        //ENTER PORT, USER, PASSWORD.
        String str1 = "SELECT * from attend, employees where attend.stid=employees.id AND attend.class = '"+teams+"' AND attend.dt = '"+dt+"'";
        Statement stm = con.createStatement();
    ...
    public void tblupdt(String teams, String dt) {
        try {
            for (int i=0; i < model.getRowCount(); i++) {
                model.removeRow(i);
                model.setRowCount(0);
            }
            ResultSet res = dbSearch(teams, dt);
