...
public class Team {  // **Class
    ...
    public int getid() throws SQLException {
        ...
        ResultSet rst = stm.executeQuery("SELECT MAX(id) from team");
        if(rst.next()) {
