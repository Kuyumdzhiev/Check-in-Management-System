...
public class Home {
    public void homeView(int id) throws SQLException {
        ...
        //-EMPLOYEES-
        JButton students = new JButton("EMPLOYEES");
        students.setBounds(150, 125, 700, 60);
        students.setFont(btn);
        students.setBackground(Color.decode("#DEE4E7"));
        students.setForeground(Color.decode("#124b70"));
        frame.add(students);
        students.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Employees std = new Employees(); //Employees std = new Employees();
                try {
                    std.employeesView(); //std.employeesView();
        ...
        addattendance.setForeground(Color.decode("#124b70"));
        ...
        editattendance.setForeground(Color.decode("#124b70"));
        ...
        //-TEAM_LEADERS-
        JButton teacher = new JButton("TEAM LEADERS"); //TeamLeaders
        ...
        teacher.setForeground(Color.decode("#124b70"));
        frame.add(teacher);
        teacher.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                TeamLeaders teamLeader = new TeamLeaders(); //TeamLeaders teamLeader = new TeamLeaders();
                try {
                    teamLeader.teamLeadersView(); //teamLeader.teamLeadersView();
                } catch (SQLException e1) {
                    e1.printStackTrace();
                }
            }
        ...
        admin.setForeground(Color.decode("#124b70"));
        frame.add(admin);
        ...
        teams.setBounds(450, 500, 400, 60);
        teams.setFont(new Font("Times New Roman", Font.BOLD, 20));
        teams.setBackground(Color.decode("#DEE4E7"));
        teams.setForeground(Color.decode("#124b70"));
        frame.add(teams);
        teams.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Team teamForce = new Team(); // Team teamForce = new Team();
                teamForce.teamView(); //teamView
            }
        });
