...
public class Login{
    ...
    public void loginView() {
        ...
        Home hm = new Home();
        TeamLeader_View tlview = new TeamLeader_View();
        Employee_View empview = new Employee_View();

        //-LOGO-
        JLabel attendance = new JLabel("      CHECK-IN");
        attendance.setForeground(Color.decode("#124b70"));
        ...
        management.setForeground(Color.decode("#124b70"));
        ...
        login.setForeground(Color.decode("#124b70"));
        frame.add(login);
