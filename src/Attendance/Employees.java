...
public class Employees {
    ...
    public void employeesView() throws SQLException {
        ...
        back.setForeground(Color.decode("#124b70"));
        ...
        idbox.setFont(text);
        idbox.setForeground(Color.decode("#124b70"));
        ...
        teams.setFont(text);
        teams.setBounds(250, 60, 100, 20);
        teams.setForeground(Color.decode("#DEE4E7"));
        frame.add(teams);
        @SuppressWarnings("unchecked")
        JComboBox tms= new JComboBox(teamEt());
        tms.setBounds(350, 60, 50, 25);
        ...
        username.setForeground(Color.decode("#124b70"));
        ...
        name.setFont(text);
        name.setForeground(Color.decode("#124b70"));
        ...
        password.setForeground(Color.decode("#124b70"));
        ...
        save.setForeground(Color.decode("#124b70"));
        ...
        save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(check == 1) {
                    try {
                        adder(Integer.parseInt(idbox.getText()),
                                username.getText(),
                                name.getText(),
                                password.getText(), String.valueOf(tms.getSelectedItem()));
                    }
                    ...
                    try {
                        if(password.getText().equals(""))
                            editor(Integer.parseInt(idbox.getText()),
                                    username.getText(),
                                    name.getText(), String.valueOf(tms.getSelectedItem()));
                        else
                            editor(Integer.parseInt(idbox.getText()),
                                    username.getText(),
                                    name.getText(),
        ...
        edit.setForeground(Color.decode("#124b70"));
        frame.add(edit);
        ...
        add.setForeground(Color.decode("#124b70"));
        frame.add(add);
        ...
        delete.setForeground(Color.decode("#124b70"));
        delete.setEnabled(false);
        frame.add(delete);
    ...
    public ResultSet dbSearch() throws SQLException {
        ...
        String str1 = "SELECT user.id, user.username, employees.name FROM user, employees where user.id = employees.id";
    ...
    public void adder(int id, String user, String name, String password, String teams) throws SQLException {
        String adding = "insert into user values ("+id+", '"+user+"', '"+name+"', '"+password+"', 3)";
        String adding2 = "insert into employees values ("+id+", '"+name+"', '"+teams+"')";
        Statement stm = con.createStatement();
    ...
    public void editor(int id, String username, String name, String password, String teams) throws SQLException {
        String update = "UPDATE user SET username = '"+username+"', name = '"+name+"', password = '"+password+"'WHERE id = "+id;
        String update2 = "UPDATE employees SET name = '"+name+"', class = '"+teams+"' WHERE id = "+id;
        Statement stm = con.createStatement();
        stm.executeUpdate(update);
        stm.executeUpdate(update2);
    }

    public void editor(int id, String username, String name, String teams) throws SQLException {
    ...
    public String[] teamEt() throws SQLException {
        String str1 = "SELECT name from team";
        Statement stm = con.createStatement();
        ResultSet rst = stm.executeQuery(str1);
