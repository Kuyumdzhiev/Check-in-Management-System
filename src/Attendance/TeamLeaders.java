...
public class TeamLeaders {
    ...
    public void teamLeadersView() throws SQLException {
    ...
    public ResultSet dbSearch() throws SQLException {
        ...
        String str1 = "SELECT user.id, user.username, teamliders.name FROM user, teamliders where user.id = teamliders.id";
    ...
    public void adder(int id, String user, String name, String password) throws SQLException {
        ...
        String adding2 = "insert into teamliders values ("+id+", '"+name+"')";
        Statement stm = con.createStatement();
    ...
    public void deleter(int id) throws SQLException {
        String del = "DELETE FROM teamliders WHERE id = "+id;
    ...
    public void editor(int id, String username, String name, String password) throws SQLException {
        ...
        String update2 = "UPDATE teamliders SET name = '"+name+"' WHERE id = "+id;
        Statement stm = con.createStatement();
